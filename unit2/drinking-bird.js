...
function createBody() {
	...
	var body, connector;
	body = new THREE.Mesh(new THREE.SphereGeometry(58, 32, 16), sphereMaterial);
	body.position = new THREE.Vector3(0, 160, 0);
	scene.add(body);
	connector = new THREE.Mesh(new THREE.CylinderGeometry(12, 12, 390, 32), cylinderMaterial);
	connector.position = new THREE.Vector3(0, 160 + 390/2, 0);
	scene.add(connector);
...
function createHead() {
	var sphereMaterial = new THREE.MeshLambertMaterial( { color: 0xA00000 } );
	var cylinderMaterial = new THREE.MeshLambertMaterial( { color: 0x0000D0 } );
	var head, hatBase, hatTop;
	head = new THREE.Mesh(new THREE.SphereGeometry(52, 32, 16), sphereMaterial);
	head.position = new THREE.Vector3(0, 160 + 390, 0);
	scene.add(head);
	hatBase = new THREE.Mesh(new THREE.CylinderGeometry(71, 71, 10, 32), cylinderMaterial);
	hatBase.position = new THREE.Vector3(0, 160 + 390 + 40 + 10/2, 0);
	scene.add(hatBase);
	hatTop = new THREE.Mesh(new THREE.CylinderGeometry(40, 40, 70, 32), cylinderMaterial);
	hatTop.position = new THREE.Vector3(0, 160 + 390 + 40 + 10 + 70/2, 0);
	scene.add(hatTop);
}
